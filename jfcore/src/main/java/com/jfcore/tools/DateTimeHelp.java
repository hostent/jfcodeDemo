...
public class DateTimeHelp {
	...
	public static void main(String[] args) {
		...
		System.out.println(DateTimeHelp.getDayBegin(new Date())); 
    ...
    public static Date getBeginDayOfYesterday(){
        Calendar cal=Calendar.getInstance();
        cal.setTime(getDayBegin(new Date()));//当天开始时间
     ...
     * @return
     */
    public static int dateDiffMinute(Date beginDate, Date endDate) {
        if(beginDate==null||endDate==null) {
            throw new IllegalArgumentException("getDiffDays param is null!");
        }
   ...
   */
     ...
     * @throws ParseException
     */
    public static String DateToString(String str, Date date) throws ParseException{
